...
```{r fig-tensor, fig.height=6, fig.width=7, Cache=FALSE}
plot_basis(mobility~racial_seg+single_mom, opportunity,
              splines=4)
```

You can then plot the fitted spline to examine the geographical pattern of the outcome. The figure here is a view of the US from the southeast.
